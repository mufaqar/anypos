    ...
    <section className='relative py-28 bg-gradient-to-tr from-[#E2F0FB] via-[#E2F0FB] to-[#FFFFFF]'>
        ...
        <div className='container mx-auto grid md:grid-cols-3 grid-cols-1 gap-10 items-center'>
            <div className='col-span-2'>
                <h3 className='text-[#2A2A2A] md:text-[32px] text-[28px] leading-[1em] font-medium tracking-[0.5px] mb-4'>Simple solution for</h3>
                <h1 className='text-[#2A2A2A] md:text-[60px] text-[50px] leading-[1em] font-medium tracking-[0.5px] mb-4'>Simplified Invoice</h1>
                <h3 className='text-[#2A2A2A] md:text-[32px] text-[28px] leading-[1em] font-medium tracking-[0.5px] mb-4'>Point of sale in any device.</h3>
