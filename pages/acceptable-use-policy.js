      ...
      <div className="container mx-auto content_box">
        <div>
          <p>
            ...
            by anypos under any ongoing agreement. It’s designed to protect us,
            our customers, and the general Internet community from unethical,
            irresponsible, and illegal activity.
          </p>
          <p>
            anypos customers found engaging in activities prohibited by this
        ...
        <div>
          ...
          <p>
            ...
            includes but isn’t limited to subscribing email addresses or
            telephone numbers to any messaging list without the permission of
            the email address or telephone number owner, and storing any email
            addresses or telephone numbers subscribed in this way. All messaging
            lists run on or hosted by our Products must be “confirmed opt-in”.
            Verification of the address or telephone number owner’s express
        ...
        <div>
          <h3>Unauthorized use of anypos property</h3>
          <p>
            We prohibit the impersonation of anypos , the representation of a
            significant business relationship with anypos , or ownership of any
            anypos property (including our Products and brand) for the purpose
