...
export default function Acceptable_Use_Policy() {
    return (
        <section className='pt-28 pb-16'>
            ...
            <div className='container mx-auto content_box'>
                <div>
                    <p>This acceptable use policy covers the products, services, and technologies (collectively referred to as the “Products”) provided by anypos under any ongoing agreement. It’s designed to protect us, our customers, and the general Internet community from unethical, irresponsible, and illegal activity.</p>
                    <p>anypos customers found engaging in activities prohibited by this acceptable use policy can be liable for service suspension and account termination. In extreme cases, we may be legally obliged to report such customers to the relevant authorities.</p>
                    <p>This policy was last reviewed on 15 November 2021.</p>
                </div>
                <div>
                    <h3>
                        Fair use
                ...
                <div>
                    <h3>
                        Unauthorized use of anypos property
                    </h3>
                    <p>
                        We prohibit the impersonation of anypos, the representation of a significant business relationship with anypos, or ownership of any anypos property (including our Products and brand) for the purpose of fraudulently gaining service, custom, patronage, or user trust.
                    </p>
                </div>
                <div>
                    <h3>
