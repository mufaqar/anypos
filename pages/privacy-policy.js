...
export default function Privacu_Policy() {
  return (
    <section className="pt-28 pb-16">
      ...
      <div className="container mx-auto content_box">
        <div>
          <p>
            Your privacy is important to us. It is anypos ’ policy to respect
            ...
            including via our app, anypos , and its associated services.
          </p>
          <p>
          ...
          <p>This policy is effective as of 15 November 2021.</p>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              ...
              rovide their services, including (without limitation) IT service
              providers, data storage, hosting and server providers, error
              loggers, debt collectors, maintenance or roblem-solving providers,
        ...
        <div>
          ...
          <p>
            ...
            you with a particular service or offer (for example serving
            particular content to your device), we will not deny you goods or
        ...
        <div>
          ...
          <p>
            ...
            privacy policy, we will post the changes here and on our website.
          </p>
          <p>
