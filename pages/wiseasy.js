            ...
            <section className='relative py-14'>
                ...
                <div className='container mx-auto grid md:grid-cols-4 grid-cols-1 gap-5'>
                    ...
                    <ImageBox
                        ...
                        title="Memory"
                        features={[
                            '1GB DDR3, 8GB Flash Optional: 2+16GB',
                        ]}
                        variations="bg-white py-5 rounded-[5px] hover:shadow-lg flex gap-3 items-center px-2" />
                    <ImageBox
                        Featue_Img={OS_icon4}
                    ...
                    <ImageBox
                        ...
                        title="NFC"
                        features={[
                            'ISO/IEC 14443 Type A&B, Felica, Mifare',
                        ]}
                        variations="bg-white py-5 rounded-[5px] hover:shadow-lg flex gap-3 items-center px-2" />
                    <ImageBox
                    ...
                    <ImageBox
                        ...
                        features={[
                            'Support Flash, White Light Compensation',
                        ]}
                        variations="bg-white py-5 rounded-[5px] hover:shadow-lg flex gap-3 items-center px-2" />
                    <ImageBox
                    ...
                    <ImageBox
                        ...
                        title="Adapter"
                        features={[
                            'Input: AC 100-240V, 50/60Hz 0.35A Output:5V/2A',
                        ]}
                        variations="bg-white py-5 rounded-[5px] hover:shadow-lg flex gap-3 items-center px-2" />
                    <ImageBox
